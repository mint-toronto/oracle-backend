...
class Oracle:
    def __init__(self):
        ...
        self.letter_grade = ['A+', 'A', 'A-', 'B+', 'B', 'B-', 'C+', 'C', 'C-', 'D+', 'D', 'D-', 'F', 'F-']
        self.letter_grade_key = {i: self.letter_grade[i] for i in range(len(self.letter_grade))}
    ...
    def predict_mark(self, mark_wgt):
        ...
        return self.letter_grade_key[np.argmax(dist)]
